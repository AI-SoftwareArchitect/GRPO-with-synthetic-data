...
def main():
    """Main program"""
    print("=" * 60)
    print("GRPO TRANSFORMER - SIFIRDAN YAPAY ZEKA MODELI")
    print("Group Relative Policy Optimization with Self-Certainty")
    print("=" * 60)
    
    while True:
        print("\nSeçenekler:")
        print("1 - Train: Yapay zekayı data.json ile train et")
        print("2 - Test: Modeli test et (sohbet modu)")
        print("3 - Exit: Programdan çık")
